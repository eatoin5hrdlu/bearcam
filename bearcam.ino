...
#ifdef DEBUG
byte pelco_stop[6]  = "czsss";
byte pelco_right[6] = "czrss";
byte pelco_left[6]  = "czlss";
byte pelco_up[6]    = "czuss";
byte pelco_down[6]  = "czdss";
byte pelco_in[6]    = "cziss";
byte pelco_out[6]   = "czoss";
#else
...
#ifdef DEBUG
	Serial.begin(115200, SERIAL_8N1); /* default */
